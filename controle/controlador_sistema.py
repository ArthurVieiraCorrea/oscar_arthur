...
class ControladorSistema:
    ...
    def abre_tela(self):
        while True:
            try:
                botao, _ = self.__tela_sistema.open()
                ...
                match botao:
                    ...
                    case '0 - Sair' | None:
                        self.__tela_sistema.show_message("Encerrando sistema", "Sistema encerrado com sucesso.")
                        break
            except Exception as e:
                self.__tela_sistema.show_message("Erro inesperado", str(e))
                continue
